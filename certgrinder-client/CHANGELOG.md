# Change Log
This is the changelog for certgrinder-client. The latest version of this file can always be found [on Github](https://github.com/tykling/certgrinder/blob/master/certgrinder-client/CHANGELOG.md)

All notable changes to certgrinder-client will be documented in this file.
...
- Rename to certgrinder-client.py
